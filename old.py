...
def onClick(event):
    global activePiece, activeLocation
...
def updateValidMoves():
    ...
    if piece == 0 or piece == 14:#rooks
        ...
        c = 1
        while notFinnished:
            if activeLocation[0]+c>=boardSize and board[activeLocation[0]][activeLocation[1]+c]==-1:
        ...
        while notFinnished:
            if activeLocation[1]-c<0 and board[activeLocation[0]][activeLocation[1]-c]==-1:
                ...
                notFinnished = False
    elif piece == 4 or piece == 10:#bishops
        notFinnished = True
        c = 1
        while notFinnished:
        ...
        c = 1
        while notFinnished:
            if activeLocation[1]-c>=0 and activeLocation[1]-c>=0 and board[activeLocation[0]][activeLocation[1]-1]==-1:
                valid.append([activeLocation[0],activeLocation[1]-c])
                c+=1
            else:
                notFinnished = False
